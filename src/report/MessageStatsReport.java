...
public class MessageStatsReport extends Report implements MessageListener {
	...
	public void done() {
		...
		String statsText = "created: " + this.nrofCreated +
			...
			;
		/*String statsText = "created	|	started	|	relayed	|	aborted	|	dropped	|	removed	|	 delivered	|	delivery_prob	|"
				+ "	response_prob	|	noverhead_prob	|	noverhead_radio	|	latency_avg	|	latency_med	|	hopcount_avg	|"
				+ "hopcount_med	|	buffertime_avg	|	buffertime_med	|	nrtt_avg	|	nrtt_med	|"
				+ "\n"
				+ this.nrofCreated + "	|	" + this.nrofStarted + "	|	" + this.nrofRelayed + "	|	" + this.nrofAborted +
				"	|	" + this.nrofDropped + "	|	" + this.nrofRemoved + "	|	" + this.nrofDelivered + "	|	"
				+ format(deliveryProb) + "	|	" + format(responseProb) + "	|	" + format(overHead) + "	|	" + getAverage(this.latencies) +
				"	|	" + getMedian(this.latencies) + "	|	" + getIntAverage(this.hopCounts) + "	|	" + getIntMedian(this.hopCounts) +
				"	|	" + getAverage(this.msgBufferTime) + "	|	" + getMedian(this.msgBufferTime) + "	|	" + getAverage(this.rtt) +
				"	|	" + getMedian(this.rtt) + "\n";*/
