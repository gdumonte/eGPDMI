...
public class Message implements Comparable<Message> {
	private int indice_calssificacao = -1;
	...
	public Message(DTNHost from, DTNHost to, String id, int size) {
		...
		//System.out.println(Double.toString(this.timeCreated) + " | " + this.from + " --> " + this.to + " MENSAGEM ID: " + this.id);
	...
	public int getIndice_calssificacao() {
		return indice_calssificacao;
	}

	public void setIndice_calssificacao(int indice_calssificacao) {
		this.indice_calssificacao = indice_calssificacao;
	}
