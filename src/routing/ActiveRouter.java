...
public abstract class ActiveRouter extends MessageRouter {
	...
	//variaveis que controlam o protocolo
	public InterestNodes interestNodes = new InterestNodes();
	public int nodes_cluster = 20;
	...
	public boolean createNewMessage(Message m) {
		//CRIA ESPA�O NO BUFFER PARA MENSAGEM
	...
	//Metodo de confirmacao de recebimento da mensagem
	@Override
	public Message messageTransferred(String id, DTNHost from) {		
		...
		System.out.println("REPASSOU A MENSAGEM: " + m.getId() + " ");
		System.out.println("MENSAGEM RECEBIDA PELO NODE");
		System.out.println();
		return m;
	}
	...
	//Metodo de transferencia de pacotes entre os nodos
	protected int startTransfer(Message m, Connection con) {

		if(m.getIndice_calssificacao() == -1){
			m.setIndice_calssificacao(MessageCreateEvent.indice_classificacao);
		}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////		
		...
		if (retVal == RCV_OK) { // started transfer
			...
			//compara a preferencia entre os nodos
			if(GPDMI.isGrupoIntermediario(m.getId() , con.getOtherNode(getHost()).getAddress(), m.getTo().getAddress())){

				boolean var = GPDMI.isGrupoPrincipal(m.getId(), con.getOtherNode(getHost()).getAddress());
				System.out.print("Node A: " + getHost().getAddress() + " | ");				
				System.out.print("Node B: " + con.getOtherNode(getHost()).getAddress() + " | ");				
				System.out.println(getHost().getAddress() + " --> " + con.getOtherNode(getHost()).getAddress());
				System.out.println();
	...
	public void update() {
		...
		for (int i=0; i<this.sendingConnections.size(); ) {
			...
			/* remove connections that have gone down */
				...
				System.out.println("N�O REPASSOU A MENSAGEM");
				System.out.println();
				if (con.getMessage() != null) {
					transferAborted(con);
					con.abortTransfer();
